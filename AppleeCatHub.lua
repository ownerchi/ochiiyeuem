...
if Enemy and Enemy:IsA("Model") and Head and IsAlive(Enemy) then
...
if RegisterAttack and RegisterAttack.FireServer then
...
if playerGui and not playerGui:FindFirstChild("ChooseTeam") then
    warn("ChooseTeam GUI không tồn tại!")
end
if chooseTeam then
    chooseTeam.Visible = true
    warn("Đã ép ChooseTeam.Visible = true")
end
if uiController then
    warn("uiController đã được phát hiện.")
end


    if chooseTeam and uiController then
    chooseTeam.Visible = true
...
local Level = 1
pcall(function()
    Level = Players.LocalPlayer:WaitForChild("Data"):WaitForChild("Level").Value
end)
            ...
            for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                if v:FindFirstChild('HumanoidRootPart') then
                    if not v:FindFirstChild("MobEap") then
                        ...
                        BillboardGui.Name = "BananaHubUI"
                        BillboardGui.AlwaysOnTop=true
                        BillboardGui.LightInfluence=1.000
                        BillboardGui.Size=UDim2.new(0, 200, 0, 50)
                        BillboardGui.StudsOffset=Vector3.new(0, 2.5, 0)
                        TextLabel.Parent=BillboardGui
                        TextLabel.BackgroundColor3 = Color3.fromRGB(255, 225, 53)
...
function BKP(Point)
if Enemy and Enemy:FindFirstChild("HumanoidRootPart") and Enemy:FindFirstChildOfClass("Humanoid") and Enemy:FindFirstChildOfClass("Humanoid").Health > 0 then
    pcall(function()
        Enemy.HumanoidRootPart.CFrame = CFrameMon + Vector3.new(math.random(-3, 3), 0, math.random(-3, 3))
    end)
end
    task.wait()
if Enemy and Enemy:FindFirstChild("HumanoidRootPart") and Enemy:FindFirstChildOfClass("Humanoid") and Enemy:FindFirstChildOfClass("Humanoid").Health > 0 then
